...
from dual import dual_pivot, solution_infeasible
from primal import primal_pivot, change_tableau, solution_unbounded
...
var_conditions = [str(i) for i in var_conditions_temp] 
